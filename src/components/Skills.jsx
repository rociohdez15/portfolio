...
const icons = [
  ...
  {
    name: "Vue.js",
    src: "https://raw.githubusercontent.com/github/explore/main/topics/vue/vue.png",
    alt: "Vue.js logo",
  },
  {
    name: "PHP",
  ...
  {
    name: "CodeIgniter",
    src: "https://raw.githubusercontent.com/github/explore/main/topics/codeigniter/codeigniter.png",
...
export default function StackTecnologico() {
  return (
    <div className="bg-gray-900 text-white flex flex-col items-center font-sans pt-8 px-6">
      ...
      <div className="grid grid-cols-6 md:grid-cols-6 gap-12 max-w-5xl justify-center">
